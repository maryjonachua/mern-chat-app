...
const SideBar = () => {
  const { users, selectedUser, setSelectedUser, isUsersLoading, fetchAllMessages, allMessages, markMessagesAsRead } =
    useChatStore();
  ...
  const unreadCount = (userId) =>
    allMessages.filter((msg) => msg.senderId === userId && msg.receiverId === authUser._id && !msg.isRead).length;
                ...
                {onlineUsers.includes(user._id) && (
                  ...
                  rounded-full ring-2 ring-zinc-900"
                    ...
                    {unreadCount(user._id) !== 0 && (
                      <div className="absolute badge badge-xs indicator -top-1 left-0 bg-red-700 text-white border-0 flex items-center ">
